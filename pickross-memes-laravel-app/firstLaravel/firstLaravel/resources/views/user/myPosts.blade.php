...
@section('posts')
{!! Form::hidden('tagname',$tagname,['id'=>'tagname']) !!}   <!-- Pagination -->
...
@endforeach
@else
<div style="margin-top: 30px;"><h2>You haven't created any Memes Yet.</h2>
    <h1>Click Create Button on Top Right to start Fun.</h1>
</div>
@endif
