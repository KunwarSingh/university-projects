...
@section('comments')
{!! Form::hidden('tagname',$tagname,['id'=>'tagname']) !!}
...
@endforeach
@else
<div style="margin-top: 30px;"><h2>You haven't commented on any Meme Yet.</h2>
    <h2>Memes on which you comment will display here.</h2>
</div>
@endif
